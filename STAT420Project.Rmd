...
us_country <- updated_countries[updated_countries$Country == "US",]
canada <- updated_countries[updated_countries$Country == "Canada",]
mexico <- updated_countries[updated_countries$Country == "Mexico",]

us_country$Date=with_tz(us_country$month, "America/New_York")
canada$Date=with_tz(canada$month, "America/New_York")
mexico$Date=with_tz(mexico$month, "America/New_York")

(ggplot(us_country, aes(x = Date, y = `monthly_covid_cases`)) +
  geom_line(aes(y = `monthly_covid_cases`, color = "USA"))  +
  geom_line(data = canada, aes(color = "Canada")) +
  geom_line(data = mexico, aes(color = "Mexico")) +
  xlab('Date') +
  ylab('Count') +
  ggtitle('North American Countries Confirmed Covid Cases per Month'))


# Asian Countries
india <- updated_countries[updated_countries$Country == "India",]
china <- updated_countries[updated_countries$Country == "China",]
japan <- updated_countries[updated_countries$Country == "Japan",]

india$Date=with_tz(india$month, "America/New_York")
china$Date=with_tz(china$month, "America/New_York")
japan$Date=with_tz(japan$month, "America/New_York")


(ggplot(india, aes(x = Date, y = `monthly_covid_cases`)) +
  geom_line(aes(y = `monthly_covid_cases`, color = "India"))  +
  geom_line(data = china, aes(color = "China")) +
  geom_line(data = japan, aes(color = "Japan")) +
  xlab('Date') +
  ylab('Count') +
  ggtitle('Asian Countries Confirmed Covid Cases per Month'))
```
...
```{r}
### Strictest Countries
australia <- updated_countries[updated_countries$Country == "Australia",]
argentina <- updated_countries[updated_countries$Country == "Argentina",]
philippines <- updated_countries[updated_countries$Country == "Philippines",]

australia$Date=with_tz(australia$month, "America/New_York")
argentina$Date=with_tz(argentina$month, "America/New_York")
philippines$Date=with_tz(philippines$month, "America/New_York")

(ggplot(australia, aes(x = Date, y = `monthly_covid_cases`)) +
  geom_line(aes(y = `monthly_covid_cases`, color = "Australia"))  +
  geom_line(data = argentina, aes(color = "Argentina")) +
  geom_line(data = philippines, aes(color = "Philippines")) +
  xlab('Date') +
  ylab('Count') +
  ggtitle('Strictest Country Confirmed Covid Cases per Month'))


### Lax Countries
egypt <- updated_countries[updated_countries$Country == "Egypt",]
spain <- updated_countries[updated_countries$Country == "Spain",]
srilanka <- updated_countries[updated_countries$Country == "Sri Lanka",]

egypt$Date=with_tz(egypt$month, "America/New_York")
spain$Date=with_tz(spain$month, "America/New_York")
srilanka$Date=with_tz(srilanka$month, "America/New_York")

(ggplot(egypt, aes(x = Date, y = `monthly_covid_cases`)) +
  geom_line(aes(y = `monthly_covid_cases`, color = "Egypt"))  +
  geom_line(data = spain, aes(color = "Spain")) +
  geom_line(data = srilanka, aes(color = "Sri Lanka")) +
  xlab('Date') +
  ylab('Count') +
  ggtitle('Comparable Country Confirmed Covid Cases per Month'))
